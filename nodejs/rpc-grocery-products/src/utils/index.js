...
const { APP_SECRET, MESSAGE_BROKER_URL, EXCHANGE_NAME, MESSAGE_BROKER_USER, MESSAGE_BROKER_PASS, QUEUE_NAME} = require("../config");
...
module.exports.SubscribeMessage = async (channel) => {
  ...
  channel.bindQueue(appQueue.queue, EXCHANGE_NAME, 'PRODUCT')
