...
-type field(GOP) :: {field, gleam@option:option(binary()), GOP}.
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 188).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 359).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 363).
-spec expect(
    glexer@token:token(),
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 376).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 387).
-spec expect_name(
    list({glexer@token:token(), glexer:position()}),
    fun((binary(), list({glexer@token:token(), glexer:position()})) -> {ok, GPH} |
        {error, error()})
) -> {ok, GPH} | {error, error()}.
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 398).
-spec until(
    glexer@token:token(),
    GPM,
    list({glexer@token:token(), glexer:position()}),
    fun((GPM, list({glexer@token:token(), glexer:position()})) -> {ok,
            {GPM, list({glexer@token:token(), glexer:position()})}} |
        {error, error()})
) -> {ok, {GPM, list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 502).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 519).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 841).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 848).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 877).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 917).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1390).
-spec list(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {GVE, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    gleam@option:option(GVE),
    list(GVE),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {list(GVE),
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 301).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 315).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 329).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 345).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 540).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 530).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 488).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1065).
-spec bit_string_segment_options(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {GTC, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list(bit_string_segment_option(GTC)),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {list(bit_string_segment_option(GTC)),
            list({glexer@token:token(), glexer:position()})}} |
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1055).
-spec optional_bit_string_segment_options(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {GSV, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {list(bit_string_segment_option(GSV)),
            list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1045).
-spec bit_string_segment(
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {GSO, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
        {{GSO, list(bit_string_segment_option(GSO))},
            list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1359).
-spec delimited(
    list(GUU),
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {GUU, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    glexer@token:token()
) -> {ok, {list(GUU), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1519).
-spec comma_delimited(
    list(GVX),
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {GVX, list({glexer@token:token(), glexer:position()})}} |
        {error, error()}),
    glexer@token:token()
) -> {ok, {list(GVX), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1675).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1665).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1706).
-spec field(
    list({glexer@token:token(), glexer:position()}),
    fun((list({glexer@token:token(), glexer:position()})) -> {ok,
            {GXJ, list({glexer@token:token(), glexer:position()})}} |
        {error, error()})
) -> {ok, {field(GXJ), list({glexer@token:token(), glexer:position()})}} |
    {error, error()}.
field(Tokens, Parser) ->
    case Tokens of
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 701).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 837).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 887).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 948).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 687).
-spec statements(
    list(statement()),
    list({glexer@token:token(), glexer:position()})
) -> {ok,
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 416).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1032).
-spec todo_panic(
    list({glexer@token:token(), glexer:position()}),
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1293).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1272).
-spec record_update(
    gleam@option:option(binary()),
    binary(),
    list({glexer@token:token(), glexer:position()})
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1313).
-spec case_subjects(
    list(expression()),
    list({glexer@token:token(), glexer:position()})
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1347).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1162).
-spec call(
    list(field(expression())),
    expression(),
    list({glexer@token:token(), glexer:position()})
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1134).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1237).
-spec fn_capture(
    gleam@option:option(binary()),
    expression(),
    list(field(expression())),
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 756).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 787).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 736).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 713).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1337).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1325).
-spec case_clauses(
    list(clause()),
    list({glexer@token:token(), glexer:position()})
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1306).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1618).
-spec named_type(
    binary(),
    gleam@option:option(binary()),
    list({glexer@token:token(), glexer:position()})
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1591).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 674).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1507).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 724).
-spec assignment(
    assignment_kind(),
    list({glexer@token:token(), glexer:position()})
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1443).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1374).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1459).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 644).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1485).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1577).
-spec type_alias(
    module_(),
    list(attribute()),
    binary(),
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1633).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1641).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1694).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1683).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1647).
-spec custom_type(
    module_(),
    list(attribute()),
    binary(),
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 1550).
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 428).
-spec slurp(
    module_(),
    list(attribute()),
    list({glexer@token:token(), glexer:position()})
...
-file("/Users/louis/src/gleam/glance/src/glance.gleam", 293).
