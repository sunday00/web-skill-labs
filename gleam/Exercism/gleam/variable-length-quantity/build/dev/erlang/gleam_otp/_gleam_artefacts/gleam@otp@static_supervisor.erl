...
-file("src/gleam/otp/static_supervisor.gleam", 74).
-spec new(strategy()) -> builder().
new(Strategy) ->
    {builder, Strategy, 2, 5, never, []}.

-file("src/gleam/otp/static_supervisor.gleam", 94).
?DOC(
...
-file("src/gleam/otp/static_supervisor.gleam", 104).
?DOC(
...
-file("src/gleam/otp/static_supervisor.gleam", 184).
...
-file("src/gleam/otp/static_supervisor.gleam", 197).
?DOC(
...
-file("src/gleam/otp/static_supervisor.gleam", 219).
?DOC(
...
-file("src/gleam/otp/static_supervisor.gleam", 241).
?DOC(
...
-file("src/gleam/otp/static_supervisor.gleam", 252).
?DOC(
...
-file("src/gleam/otp/static_supervisor.gleam", 263).
?DOC(
...
-file("src/gleam/otp/static_supervisor.gleam", 294).
-spec property(
...
-file("src/gleam/otp/static_supervisor.gleam", 267).
...
-file("src/gleam/otp/static_supervisor.gleam", 165).
...
-file("src/gleam/otp/static_supervisor.gleam", 304).
?DOC(false).
