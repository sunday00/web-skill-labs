-module(plain_strings).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch]).

-export([main/0]).

-file("src/plain_strings.gleam", 4).
...
main() ->
    ...
    echo(
        begin
            ...
            _pipe@2 = gleam@list:window(_pipe@1, 3),
            gleam@list:map(_pipe@2, fun erlang:list_to_binary/1)
        end,
        "src/plain_strings.gleam",
        7
    ).
