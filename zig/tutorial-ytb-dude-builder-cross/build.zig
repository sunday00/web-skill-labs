...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("tutorial_ytb_dude_builder_cross", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "tutorial_ytb_dude_builder_cross" is the name you will use in your source code to
                // import this module (e.g. `@import("tutorial_ytb_dude_builder_cross")`). The name is
